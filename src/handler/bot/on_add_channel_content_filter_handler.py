...
class OnAddChannelContentFilterHandler(BotEventHandler):
    INSTRUCTION = """
        ...
        1. `hashtags` - предикат от нескольких аргументов, проверяющий есть ли в посте канала соответствующие хештеги
        *Пример*: `hashtags(реклама, рассылка)`
        
        2. `links` - предикат, проверяющий есть ли в посте канала какие-либо ссылки
        *Пример*: `links`
